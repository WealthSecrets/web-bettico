...
class PrimaryColor {
  static const MaterialColor color = MaterialColor(_betticosPrimaryValue, <int, Color>{
    ...
    300: Color(0xFF8F5DC1),
    400: Color(0xFF773AB4),
    500: Color(_betticosPrimaryValue),
    600: Color(0xFF57149F),
    700: Color(0xFF4D1196),
    800: Color(0xFF430D8C),
    900: Color(0xFF32077C),
  });
  ...
  static const MaterialColor accent = MaterialColor(_betticosAccentValue, <int, Color>{
    ...
    700: Color(0xFF6D2BFF),
  });
  static const int _betticosAccentValue = 0xFFA178FF;
}
