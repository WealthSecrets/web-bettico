...
class MessageCard extends StatelessWidget {
  const MessageCard({super.key, required this.messageType, this.unread = true});
                      ...
                      child: Row(
                        children: <Widget>[
                          Text(
                            'Blankson',
                            style: context.body1
                                .copyWith(color: context.colors.black, fontWeight: FontWeight.w600, letterSpacing: 0.1),
                          ),
