...
class BetticosRemoteDataSourceImpl implements BetticosRemoteDataSource {
  ...
  @override
  Future<Repost> likeRepost({required String repostId, required UserRequest request}) async {
    final Map<String, dynamic> json =
        await _client.post(BetticosEndpoints.likeRepost(repostId), body: request.toJson());
    return Repost.fromJson(json['data'] as Map<String, dynamic>);
  }

  @override
  Future<Repost> dislikeRepost({required String repostId, required UserRequest request}) async {
    final Map<String, dynamic> json =
        await _client.post(BetticosEndpoints.dislikeRepost(repostId), body: request.toJson());
    return Repost.fromJson(json['data'] as Map<String, dynamic>);
  }
  ...
  @override
  Future<List<Post>> getMyComments(String userId) async {
    final Map<String, dynamic> json = await _client.get(BetticosEndpoints.myComments(userId));
    final List<dynamic> items = json['items'] as List<dynamic>;
    return List<Post>.from(
      items.map<Post>(
        (dynamic json) => Post.fromJson(json as Map<String, dynamic>),
  ...
  @override
  Future<List<Post>> getMyLikedPosts(String userId) async {
    final Map<String, dynamic> json = await _client.get(BetticosEndpoints.likedPosts(userId));
    final List<dynamic> items = json['items'] as List<dynamic>;
    return List<Post>.from(items.map<Post>((dynamic json) => Post.fromJson(json as Map<String, dynamic>)));
  }

  @override
  Future<List<Post>> getMyBookmarks(String userId) async {
    final Map<String, dynamic> json = await _client.get(BetticosEndpoints.bookmarks(userId));
    final List<dynamic> items = json['items'] as List<dynamic>;
    return List<Post>.from(items.map<Post>((dynamic json) => Post.fromJson(json as Map<String, dynamic>)));
  }

  @override
  Future<List<Repost>> getMyReposts(String userId) async {
    final Map<String, dynamic> json = await _client.get(BetticosEndpoints.userReposts(userId));
    final List<dynamic> items = json['items'] as List<dynamic>;
    return List<Repost>.from(
