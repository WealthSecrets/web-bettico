...
class WebsiteModal extends StatefulWidget {
  const WebsiteModal({super.key, required this.user});

  final User user;

  @override
  State<WebsiteModal> createState() => _WebsiteModalState();
}

class _WebsiteModalState extends State<WebsiteModal> {
  ...
  void initState() {
    ...
    controller.website.value = widget.user.website ?? '';
  }
            ...
            child: AppAnimatedColumn(
              ...
              children: <Widget>[
                ...
                AppTextInput(
                  ...
                  validator: InputValidators.isRequired,
                  onChanged: controller.onWebsiteInputChange,
                ),
                const SizedBox(height: 24),
                AppButton(
                  enabled: controller.website.value.isNotEmpty,
