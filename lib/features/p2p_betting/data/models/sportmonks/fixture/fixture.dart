...
@freezed
class SFixture with _$SFixture {
  const factory SFixture({
    required int id,
  ...
  factory SFixture.fromJson(Map<String, dynamic> json) =>
      _$SFixtureFromJson(json);

  factory SFixture.mock() => const SFixture(
        id: 1,
        leagueId: 0,
        localTeamId: 0,
        visitorTeamId: 0,
  ...
  factory SFixture.empty() => const SFixture(
        id: 1,
        leagueId: 0,
        localTeamId: 0,
        visitorTeamId: 0,
