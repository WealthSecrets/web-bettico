class P2pEndpoints {
  ...
  static String competitionMatches(String apiKey, String secretKey, int competitionId, int teamId) =>
  ...
  static String teamMatch(String apiKey, String secretKey, int teamId, int competitionId, String date) =>
  ...
  static String fixture(String apiKey, String secretKey, int competitionId, int teamId, String date) =>
