class TransactionEndpoints {
  ...
  static String userDeposits(String userId) => 'transactions/user/$userId/deposits';
  static String userWithdrawals(String userId) => 'transactions/user/$userId/withdrawals';
