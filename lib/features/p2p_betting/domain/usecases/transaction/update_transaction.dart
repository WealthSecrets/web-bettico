...
class UpdateTransaction implements UseCase<Transaction, TransactionUpdateRequest> {
  ...
  Future<Either<Failure, Transaction>> call(TransactionUpdateRequest params) {
    return p2prepository.updateTransaction(betId: params.betId, hash: params.hash ?? '');
  }
}
