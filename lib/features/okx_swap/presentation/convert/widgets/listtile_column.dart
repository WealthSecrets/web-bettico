  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: <Widget>[
        Text(
          title,
          style: TextStyle(fontSize: 16, fontWeight: FontWeight.normal, color: context.colors.text),
        ),
        ...
        ListTile(
          ...
          subtitle:
              Text(amount, style: TextStyle(fontSize: 16, color: context.colors.primary, fontWeight: FontWeight.bold)),
        ),
      ],
    );
  }
