class OkxEndpoints {
  ...
  static String deleteSubAccount(String id) => 'okx/broker/delete-subaccount/$id';
  ...
  static const String withdrawalHistory = 'okx/broker/subaccount-withdrawal-history';
