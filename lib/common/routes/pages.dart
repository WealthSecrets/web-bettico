...
class Pages {
  static final List<GetPage<AppRoutes>> pages = <GetPage<AppRoutes>>[
    ...
    GetPage<AppRoutes>(name: AppRoutes.newRegistration, page: () => const NewRegistrationScreen()),
    GetPage<AppRoutes>(name: AppRoutes.newPasswordScreen, page: () => const NewPasswordScreen()),
    ...
    GetPage<AppRoutes>(name: AppRoutes.bio, page: RegistrationFollowAccountsScreen.new),
