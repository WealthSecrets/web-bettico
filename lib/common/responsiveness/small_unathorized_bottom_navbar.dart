...
class SmallUnAthenticatedBottomNavbar extends StatelessWidget {
  const SmallUnAthenticatedBottomNavbar({super.key});
          ...
          children: <Widget>[
            ...
            InkWell(
              ...
              child: Container(
                height: 40,
                width: 40,
                decoration: BoxDecoration(color: context.colors.lightGrey, borderRadius: BorderRadius.circular(40)),
                child: Icon(Ionicons.log_in_sharp, size: 24, color: context.colors.primary),
              ),
            ),
          ],
        ),
